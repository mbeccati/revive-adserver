...
class Plugins_DeliveryLimitations_Site_Registerabledomainlist extends Plugins_DeliveryLimitations
{
    ...
    function __construct()
    {
        $this->aOperations = array(
            '=x' => MAX_Plugin_Translation::translate('Whitelist - Only deliver on these registerable domains', $oPlugin->extension, $oPlugin->group),
            '!x' => MAX_Plugin_Translation::translate('Blacklist - Do not deliver on these registerable domains', $oPlugin->extension, $oPlugin->group)
        );
