...
class Plugins_DeliveryLimitations_Site_Hostnamelist extends Plugins_DeliveryLimitations
{
    ...
    function __construct()
    {
        $this->aOperations = array(
            '=~' => MAX_Plugin_Translation::translate('Whitelist - Only deliver on these hostnames', $oPlugin->extension, $oPlugin->group),
            '!~' => MAX_Plugin_Translation::translate('Blacklist - Do not deliver on these hostnames', $oPlugin->extension, $oPlugin->group)
        );
